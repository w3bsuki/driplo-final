    ...
    def parse_error_file(self, file_path: str) -> List[Dict]:
        ...
        try:
            ...
            while i < len(lines):
                ...
                if 'driplo.bg-main' in line and ':' in line and ('Error' in lines[i+1] if i+1 < len(lines) else False):
                ...
                elif '[31mError[39m:' in line or 'Error:' in clean_line:
                    if current_error:
                        ...
                        j = i + 1
                        while j < len(lines) and not lines[j].strip().startswith('k:\\') and not '[31mError[39m:' in lines[j]:
    ...
    def generate_report(self) -> Dict:
        ...
        report = {
            'summary': {
                ...
                'error_files_analyzed': len(self.error_files)
            },
