...
<!-- Use standard Tailwind classes instead of CSS custom properties in arbitrary values -->
								...
								<div class="flex items-center gap-2 overflow-x-auto scrollbar-hide">
									{#each categories.slice(0, DESKTOP_CATEGORY_LIMIT) as category}
										<button
											...
											class="flex items-center gap-1.5 px-3 py-2 rounded-sm bg-white border border-gray-200 hover:bg-gray-50 text-gray-600 text-sm font-medium whitespace-nowrap transition-colors duration-100 focus:outline-none focus:ring-1 focus:ring-brand-500"
										>
