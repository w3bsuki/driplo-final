<script lang="ts">
	import { _Badge} from '$lib/components/ui'
	import { Button } from '$lib/components/ui'
	import BrandBadge from '$lib/components/ui/BrandBadge.svelte'
	import ProgressBar from '$lib/components/ui/ProgressBar.svelte'
	import { Camera, MapPin, Calendar, _ExternalLink, MessageCircle, UserPlus, UserMinus, Award, Star, Building2 } from 'lucide-svelte'
	...
	<div class="px-4 sm:px-6 pb-4 sm:pb-6">
		...
		{#if profile?.achievements?.length > 0}
			<div class="mt-4 flex gap-2 overflow-x-auto pb-2">
				{#each profile?.achievements.slice(0, 5) as _achievement}
