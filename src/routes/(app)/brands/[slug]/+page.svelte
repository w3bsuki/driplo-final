<script lang="ts">
	...
	import { Building2, Globe, Instagram, Facebook, Twitter, MapPin, Calendar, Star, Package, _ShoppingBag, _Users, _TrendingUp, ExternalLink, Check } from 'lucide-svelte';
